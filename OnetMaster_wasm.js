...
var ASM_CONSTS = {
    ...
    123843: function($0) {
        var jsResult;
        var isSuccess = 1;
        var getStr = UTF8ToString($0);
        try {
            if (getStr.indexOf('_0x1918')>-1) {
...
var JsToDef = {
    ...
    _callback_bool: null,
    _ads_end: function() {
        JsToDef.send("ADS_FINISHED")
    },
    _ads_rew_end: function(withReward) {
        JsToDef.send("ADS_REWARDED_FINISHED", withReward)
    },
    send: function(message_id, message) {
        if (JsToDef._callback_object) {
            ...
            switch (typeof message) {
                case "undefined":
                    wasmTable.get(JsToDef._callback_empty)(msg_id);
                    break;
                case "number":
                    wasmTable.get(JsToDef._callback_number)(msg_id, message);
                    break;
                case "string":
                    var msg_arr = intArrayFromString(message);
                    var msg = allocate(msg_arr, ALLOC_NORMAL);
                    wasmTable.get(JsToDef._callback_string)(msg_id, msg);
                    Module._free(msg);
                    break;
                case "object":
                    var msg = JSON.stringify(message);
                    var msg_arr = intArrayFromString(msg);
                    msg = allocate(msg_arr, ALLOC_NORMAL);
                    wasmTable.get(JsToDef._callback_object)(msg_id, msg);
                    Module._free(msg);
                    break;
                case "boolean":
                    var msg = message ? 1 : 0;
                    wasmTable.get(JsToDef._callback_bool)(msg_id, msg);
                    break;
                default:
    ...
    Poki_ShowADS: function() {
        PokiSDK.commercialBreak().then(JsToDef._ads_end)
    },
    Poki_ShowRewardedADS: function() {
        PokiSDK.rewardedBreak().then(JsToDef._ads_rew_end)
    }
};
...
var asmLibraryArg = {
    "Ih": _JsToDef_RegisterCallbacks,
    "Hh": _JsToDef_RemoveCallbacks,
    "b": ___assert_fail,
    "Gh": ___clock_gettime,
    "Fh": ___gmtime_r,
    "Eh": ___localtime_r,
    ...
    "qh": _clock,
    "ph": _difftime,
    "oh": _dmDeviceJSFreeBufferSlots,
    "nh": _dmDeviceJSOpen,
    "mh": _dmDeviceJSQueue,
    "lh": _dmGetDeviceSampleRate,
    "kh": _dmScriptHttpRequestAsync,
    "jh": _dmSysGetApplicationPath,
    "ih": _dmSysGetUserAgent,
    "hh": _dmSysGetUserPersistentDataRoot,
    "gh": _dmSysGetUserPreferredLanguage,
    "fh": _dmSysOpenURL,
    "P": _emscripten_asm_const_int,
    "eh": _emscripten_cancel_main_loop,
    "dh": _emscripten_glActiveTexture,
    "ch": _emscripten_glAttachShader,
    "bh": _emscripten_glBeginQuery,
    "ah": _emscripten_glBeginQueryEXT,
    "$g": _emscripten_glBeginTransformFeedback,
    "_g": _emscripten_glBindAttribLocation,
    "Zg": _emscripten_glBindBuffer,
    "Yg": _emscripten_glBindBufferBase,
    "Xg": _emscripten_glBindBufferRange,
    "Wg": _emscripten_glBindFramebuffer,
    "Vg": _emscripten_glBindRenderbuffer,
    "Ug": _emscripten_glBindSampler,
    "Tg": _emscripten_glBindTexture,
    "Sg": _emscripten_glBindTransformFeedback,
    "Rg": _emscripten_glBindVertexArray,
    "Qg": _emscripten_glBindVertexArrayOES,
    "Pg": _emscripten_glBlendColor,
    "Og": _emscripten_glBlendEquation,
    "Ng": _emscripten_glBlendEquationSeparate,
    "Mg": _emscripten_glBlendFunc,
    "Lg": _emscripten_glBlendFuncSeparate,
    "Kg": _emscripten_glBlitFramebuffer,
    "Jg": _emscripten_glBufferData,
    "Ig": _emscripten_glBufferSubData,
    "Hg": _emscripten_glCheckFramebufferStatus,
    "Gg": _emscripten_glClear,
    "Fg": _emscripten_glClearBufferfi,
    "Eg": _emscripten_glClearBufferfv,
    "Dg": _emscripten_glClearBufferiv,
    "Cg": _emscripten_glClearBufferuiv,
    "Bg": _emscripten_glClearColor,
    "Ag": _emscripten_glClearDepthf,
    "zg": _emscripten_glClearStencil,
    "yg": _emscripten_glClientWaitSync,
    "xg": _emscripten_glColorMask,
    "wg": _emscripten_glCompileShader,
    "vg": _emscripten_glCompressedTexImage2D,
    "ug": _emscripten_glCompressedTexImage3D,
    "tg": _emscripten_glCompressedTexSubImage2D,
    "sg": _emscripten_glCompressedTexSubImage3D,
    "rg": _emscripten_glCopyBufferSubData,
    "qg": _emscripten_glCopyTexImage2D,
    "pg": _emscripten_glCopyTexSubImage2D,
    "og": _emscripten_glCopyTexSubImage3D,
    "ng": _emscripten_glCreateProgram,
    "mg": _emscripten_glCreateShader,
    "lg": _emscripten_glCullFace,
    "kg": _emscripten_glDeleteBuffers,
    "jg": _emscripten_glDeleteFramebuffers,
    "ig": _emscripten_glDeleteProgram,
    "hg": _emscripten_glDeleteQueries,
    "gg": _emscripten_glDeleteQueriesEXT,
    "fg": _emscripten_glDeleteRenderbuffers,
    "eg": _emscripten_glDeleteSamplers,
    "dg": _emscripten_glDeleteShader,
    "cg": _emscripten_glDeleteSync,
    "bg": _emscripten_glDeleteTextures,
    "ag": _emscripten_glDeleteTransformFeedbacks,
    "$f": _emscripten_glDeleteVertexArrays,
    "_f": _emscripten_glDeleteVertexArraysOES,
    "Zf": _emscripten_glDepthFunc,
    "Yf": _emscripten_glDepthMask,
    "Xf": _emscripten_glDepthRangef,
    "Wf": _emscripten_glDetachShader,
    "Vf": _emscripten_glDisable,
    "Uf": _emscripten_glDisableVertexAttribArray,
    "Tf": _emscripten_glDrawArrays,
    "Sf": _emscripten_glDrawArraysInstanced,
    "Rf": _emscripten_glDrawArraysInstancedANGLE,
    "Qf": _emscripten_glDrawArraysInstancedARB,
    "Pf": _emscripten_glDrawArraysInstancedEXT,
    "Of": _emscripten_glDrawArraysInstancedNV,
    "Nf": _emscripten_glDrawBuffers,
    "Mf": _emscripten_glDrawBuffersEXT,
    "Lf": _emscripten_glDrawBuffersWEBGL,
    "Kf": _emscripten_glDrawElements,
    "Jf": _emscripten_glDrawElementsInstanced,
    "If": _emscripten_glDrawElementsInstancedANGLE,
    "Hf": _emscripten_glDrawElementsInstancedARB,
    "Gf": _emscripten_glDrawElementsInstancedEXT,
    "Ff": _emscripten_glDrawElementsInstancedNV,
    "Ef": _emscripten_glDrawRangeElements,
    "Df": _emscripten_glEnable,
    "Cf": _emscripten_glEnableVertexAttribArray,
    "Bf": _emscripten_glEndQuery,
    "Af": _emscripten_glEndQueryEXT,
    "zf": _emscripten_glEndTransformFeedback,
    "yf": _emscripten_glFenceSync,
    "xf": _emscripten_glFinish,
    "wf": _emscripten_glFlush,
    ...
    "Xe": _emscripten_glGetError,
    "We": _emscripten_glGetFloatv,
    "Ve": _emscripten_glGetFragDataLocation,
    "Ue": _emscripten_glGetFramebufferAttachmentParameteriv,
    "Te": _emscripten_glGetInteger64i_v,
    "Se": _emscripten_glGetInteger64v,
    "Re": _emscripten_glGetIntegeri_v,
    "Qe": _emscripten_glGetIntegerv,
    "Pe": _emscripten_glGetInternalformativ,
    "Oe": _emscripten_glGetProgramBinary,
    ...
    "Ie": _emscripten_glGetQueryObjectuiv,
    "He": _emscripten_glGetQueryObjectuivEXT,
    "Ge": _emscripten_glGetQueryiv,
    "Fe": _emscripten_glGetQueryivEXT,
    "Ee": _emscripten_glGetRenderbufferParameteriv,
    "De": _emscripten_glGetSamplerParameterfv,
    "Ce": _emscripten_glGetSamplerParameteriv,
    "Be": _emscripten_glGetShaderInfoLog,
    "Ae": _emscripten_glGetShaderPrecisionFormat,
    "ze": _emscripten_glGetShaderSource,
    "ye": _emscripten_glGetShaderiv,
    "xe": _emscripten_glGetString,
    "we": _emscripten_glGetStringi,
    "ve": _emscripten_glGetSynciv,
    "ue": _emscripten_glGetTexParameterfv,
    "te": _emscripten_glGetTexParameteriv,
    "se": _emscripten_glGetTransformFeedbackVarying,
    "re": _emscripten_glGetUniformBlockIndex,
    "qe": _emscripten_glGetUniformIndices,
    "pe": _emscripten_glGetUniformLocation,
    "oe": _emscripten_glGetUniformfv,
    "ne": _emscripten_glGetUniformiv,
    "me": _emscripten_glGetUniformuiv,
    "le": _emscripten_glGetVertexAttribIiv,
    "ke": _emscripten_glGetVertexAttribIuiv,
    "je": _emscripten_glGetVertexAttribPointerv,
    "ie": _emscripten_glGetVertexAttribfv,
    "he": _emscripten_glGetVertexAttribiv,
    "ge": _emscripten_glHint,
    "fe": _emscripten_glInvalidateFramebuffer,
    "ee": _emscripten_glInvalidateSubFramebuffer,
    "de": _emscripten_glIsBuffer,
    "ce": _emscripten_glIsEnabled,
    "be": _emscripten_glIsFramebuffer,
    "ae": _emscripten_glIsProgram,
    "$d": _emscripten_glIsQuery,
    "_d": _emscripten_glIsQueryEXT,
    "Zd": _emscripten_glIsRenderbuffer,
    "Yd": _emscripten_glIsSampler,
    "Xd": _emscripten_glIsShader,
    "Wd": _emscripten_glIsSync,
    "Vd": _emscripten_glIsTexture,
    "Ud": _emscripten_glIsTransformFeedback,
    "Td": _emscripten_glIsVertexArray,
    "Sd": _emscripten_glIsVertexArrayOES,
    "Rd": _emscripten_glLineWidth,
    "Qd": _emscripten_glLinkProgram,
    "Pd": _emscripten_glPauseTransformFeedback,
    "Od": _emscripten_glPixelStorei,
    "Nd": _emscripten_glPolygonOffset,
    "Md": _emscripten_glProgramBinary,
    "Ld": _emscripten_glProgramParameteri,
    "Kd": _emscripten_glQueryCounterEXT,
    "Jd": _emscripten_glReadBuffer,
    "Id": _emscripten_glReadPixels,
    "Hd": _emscripten_glReleaseShaderCompiler,
    "Gd": _emscripten_glRenderbufferStorage,
    "Fd": _emscripten_glRenderbufferStorageMultisample,
    "Ed": _emscripten_glResumeTransformFeedback,
    "Dd": _emscripten_glSampleCoverage,
    "Cd": _emscripten_glSamplerParameterf,
    "Bd": _emscripten_glSamplerParameterfv,
    "Ad": _emscripten_glSamplerParameteri,
    "zd": _emscripten_glSamplerParameteriv,
    ...
    "qd": _emscripten_glStencilOpSeparate,
    "pd": _emscripten_glTexImage2D,
    "od": _emscripten_glTexImage3D,
    ...
    "jd": _emscripten_glTexStorage2D,
    "id": _emscripten_glTexStorage3D,
    "hd": _emscripten_glTexSubImage2D,
    "gd": _emscripten_glTexSubImage3D,
    "fd": _emscripten_glTransformFeedbackVaryings,
    "ed": _emscripten_glUniform1f,
    "dd": _emscripten_glUniform1fv,
    "cd": _emscripten_glUniform1i,
    "bd": _emscripten_glUniform1iv,
    "ad": _emscripten_glUniform1ui,
    "$c": _emscripten_glUniform1uiv,
    "_c": _emscripten_glUniform2f,
    "Zc": _emscripten_glUniform2fv,
    "Yc": _emscripten_glUniform2i,
    "Xc": _emscripten_glUniform2iv,
    "Wc": _emscripten_glUniform2ui,
    "Vc": _emscripten_glUniform2uiv,
    "Uc": _emscripten_glUniform3f,
    "Tc": _emscripten_glUniform3fv,
    "Sc": _emscripten_glUniform3i,
    "Rc": _emscripten_glUniform3iv,
    "Qc": _emscripten_glUniform3ui,
    "Pc": _emscripten_glUniform3uiv,
    ...
    "Gc": _emscripten_glUniformMatrix2x3fv,
    "Fc": _emscripten_glUniformMatrix2x4fv,
    "Ec": _emscripten_glUniformMatrix3fv,
    "Dc": _emscripten_glUniformMatrix3x2fv,
    "Cc": _emscripten_glUniformMatrix3x4fv,
    "Bc": _emscripten_glUniformMatrix4fv,
    "Ac": _emscripten_glUniformMatrix4x2fv,
    "zc": _emscripten_glUniformMatrix4x3fv,
    "yc": _emscripten_glUseProgram,
    "xc": _emscripten_glValidateProgram,
    "wc": _emscripten_glVertexAttrib1f,
    "vc": _emscripten_glVertexAttrib1fv,
    "uc": _emscripten_glVertexAttrib2f,
    "tc": _emscripten_glVertexAttrib2fv,
    "sc": _emscripten_glVertexAttrib3f,
    "rc": _emscripten_glVertexAttrib3fv,
    "qc": _emscripten_glVertexAttrib4f,
    "pc": _emscripten_glVertexAttrib4fv,
    "oc": _emscripten_glVertexAttribDivisor,
    "nc": _emscripten_glVertexAttribDivisorANGLE,
    "mc": _emscripten_glVertexAttribDivisorARB,
    "lc": _emscripten_glVertexAttribDivisorEXT,
    "kc": _emscripten_glVertexAttribDivisorNV,
    "jc": _emscripten_glVertexAttribI4i,
    "ic": _emscripten_glVertexAttribI4iv,
    "hc": _emscripten_glVertexAttribI4ui,
    "gc": _emscripten_glVertexAttribI4uiv,
    "fc": _emscripten_glVertexAttribIPointer,
    "ec": _emscripten_glVertexAttribPointer,
    "dc": _emscripten_glViewport,
    "cc": _emscripten_glWaitSync,
    "g": _emscripten_longjmp,
    "bc": _emscripten_memcpy_big,
    "ac": _emscripten_pause_main_loop,
    "$b": _emscripten_resize_heap,
    "_": _emscripten_set_main_loop_arg,
    "_b": _emscripten_thread_sleep,
    "f": _emscripten_webgl_enable_extension,
    "Zb": _emscripten_webgl_get_current_context,
    "sh": _environ_get,
    "rh": _environ_sizes_get,
    "wa": _exit,
    "D": _fd_close,
    "xa": _fd_read,
    "Ga": _fd_seek,
...
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function() {
    return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["Kh"]).apply(null, arguments)
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function() {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = Module["asm"]["Lh"]).apply(null, arguments)
};
var _main = Module["_main"] = function() {
    return (_main = Module["_main"] = Module["asm"]["Mh"]).apply(null, arguments)
};
...
var _htonl = Module["_htonl"] = function() {
    return (_htonl = Module["_htonl"] = Module["asm"]["Ph"]).apply(null, arguments)
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function() {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = Module["asm"]["Qh"]).apply(null, arguments)
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function() {
    return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = Module["asm"]["Rh"]).apply(null, arguments)
};
