var _azerionIntegration = {
    gdId: "176415ef4cf84473b7942ab1a0ff3730",
    alxType: "std",
    advType: "gd",
    af: !1,
    sa: !1,
...
!function(global, factory) {
        ...
        Hosts.getReferrerHostName = function(url) {
            ...
            try {
                ...
                if (referrer) {
                    ...
                    if (-1 !== hostName.indexOf("gamedistribution"))
                        return "gd";
    ...
    var Utils = function() {
        ...
        Utils.ASSET_LOCATION ="./splash/assets/",
        Utils
    }();
    var DebugTools = function() {
        ...
        DebugTools.showBuildInfo = function(search) {
            ...
            DebugTools.enableDebugMode() && DebugTools.showVersioning() && ((search = document.createElement("div")).id = "az-debug-box",
            ...
            search.style.backgroundColor = "rgba(255, 255, 255, 0.4)",
            ...
            buildInfo = DebugTools.getBuildInfo(window._azerionIntegration),
            (versionElem = document.createElement("div")).id = "az-version",
            versionElem.textContent = "Build version:: ".concat(buildInfo.build.version),
            search.appendChild(versionElem),
            (versionElem = document.createElement("div")).id = "az-date",
            versionElem.textContent = "Build creation date:: ".concat(new Date(buildInfo.build.timeStamp).toDateString()),
            search.appendChild(versionElem),
            (versionElem = document.createElement("div")).id = "az-gdId",
            versionElem.textContent = "GD Id:: ".concat(buildInfo.gdId),
            search.appendChild(versionElem))
        }
        ,
        DebugTools
        ...
        SplashLoader.prototype.create = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                    case 0:
                        return DebugTools.showBuildInfo(window.location.search),
                        css = getCss(),
    ...
    var AeriaIntegration = function() {
        ...
        return AeriaIntegration.updateAeriaIFrameSrc = function() {
            try {
                var deviceType = "pc";
                (window.navigator.userAgent.includes("Mac") && "ontouchend"in document && -1 === window.navigator.userAgent.indexOf("iPhone") || window.navigator.userAgent.includes("Android") && -1 === window.navigator.userAgent.indexOf("Mobile")) && (deviceType = "tablet"),
                (window.navigator.userAgent.includes("Android") && window.navigator.userAgent.includes("Mobile") || window.navigator.userAgent.includes("Mac") && window.navigator.userAgent.includes("iPhone")) && (deviceType = "smartphone");
        ...
        AeriaIntegration.addYMenuListener = function() {
            try {
                ...
                menuButton_1.onclick = function() {
                    ...
                    "-300px" === button.style.left ? (button.style.left = "0",
                    menuButton_1.style.left = "300px") : (button.style.left = "-300px",
            ...
            void 0 !== (exports = function(require, exports, shared_1) {
                ...
                var JioAdProvider = function() {
                    ...
                    JioAdProvider.prototype.showAd = function(adType) {
                        adType === shared_1.AdType.interstitial ? this.jioGamesSP.showAdMidRoll() : adType === shared_1.AdType.rewarded && this.jioGamesSP.showAdRewarded(),
                        this.resumeGameplay()
                    }
                    ,
                    ...
                    JioAdProvider.prototype.preloadAd = function(adType) {
                        console.log("43999===preloadAd")
                        (adType = void 0 === adType ? shared_1.AdType.interstitial : adType) === shared_1.AdType.interstitial && this.jioGamesSP.cacheAdMidRoll(),
                        adType === shared_1.AdType.rewarded && this.jioGamesSP.cacheAdRewarded()
                    }
                    ,
            ...
            void 0 !== (exports = function(require, exports, shared_1, DummyBanner_1) {
                ...
                var DummyProvider = function() {
                    ...
                    DummyProvider.prototype.showAd = function(adType) {
                        ...
                        var emulateError = !1;
                        var emulateSkipAd = !1;
                        1 === num ? shared_1.AdType.rewarded : adType === shared_1.AdType.rewarded && setTimeout(function() {
            ...
            void 0 !== (exports = function(require, exports, shared_1, GameDistributionBanner_1) {
                ...
                var GameDistribution = function() {
                    ...
                    GameDistribution.prototype.showAd = function(adType) {
                        ...
                        this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)) : window.gdsdk.showAd(adType === shared_1.AdType.rewarded ? GameDistributionAdType.rewarded : GameDistributionAdType.interstitial).catch(function(e) {
                            adType === shared_1.AdType.rewarded && _this.hasRewarded && (_this.hasRewarded = !1),
                            _this.adManager.emit(shared_1.AdEvents.AD_RENDER_ERROR),
                            _this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)
                        }) : this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)
                    }
                    ,
